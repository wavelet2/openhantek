...
namespace Hantek {
    ...
    BulkSetFilter::BulkSetFilter() : TransferBuffer(8) {
        this->init();
    }
    ...
    BulkSetFilter::BulkSetFilter(bool channel1, bool channel2, bool trigger) : TransferBuffer(8) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetTriggerAndSamplerate::BulkSetTriggerAndSamplerate() : TransferBuffer(12) {
        this->init();
    }
    ...
    BulkSetTriggerAndSamplerate::BulkSetTriggerAndSamplerate(uint16_t downsampler, uint32_t triggerPosition, uint8_t triggerSource, uint8_t recordLength, uint8_t samplerateId, bool downsamplingMode, uint8_t usedChannels, bool fastRate, uint8_t triggerSlope) : TransferBuffer(12) {
        this->init();
    ...
    BulkForceTrigger::BulkForceTrigger() : TransferBuffer(2) {
    ...
    /// \brief Sets the data array to needed values.
    BulkCaptureStart::BulkCaptureStart() : TransferBuffer(2) {
    ...
    /// \brief Sets the data array to needed values.
    BulkTriggerEnabled::BulkTriggerEnabled() : TransferBuffer(2) {
    ...
    // class BulkGetData
    /// \brief Sets the data array to needed values.
    BulkGetData::BulkGetData() : TransferBuffer(2) {
    ...
    /// \brief Sets the data array to needed values.
    BulkGetCaptureState::BulkGetCaptureState() : TransferBuffer(2) {
    ...
    BulkResponseGetCaptureState::BulkResponseGetCaptureState() : TransferBuffer(512) {
    }
    ...
    // class BulkSetGain
    /// \brief Sets the data array to needed values.
    BulkSetGain::BulkSetGain() : TransferBuffer(8) {
        this->init();
    }
    ...
    BulkSetGain::BulkSetGain(uint8_t channel1, uint8_t channel2) : TransferBuffer(8) {
        this->init();
    ...
    /// \brief Sets the data array to needed values.
    BulkSetLogicalData::BulkSetLogicalData() : TransferBuffer(8) {
        this->init();
    }

    /// \brief Sets the data to the given value.
    /// \param data The data byte.
    BulkSetLogicalData::BulkSetLogicalData(uint8_t data) : TransferBuffer(8) {
        this->init();
    ...
    /// \brief Sets the data array to needed values.
    BulkGetLogicalData::BulkGetLogicalData() : TransferBuffer(2) {
    ...
    /// \brief Sets the data array to needed values.
    BulkSetChannels2250::BulkSetChannels2250() : TransferBuffer(4) {
        this->init();
    }

    /// \brief Sets the used channels.
    /// \param usedChannels The UsedChannels value.
    BulkSetChannels2250::BulkSetChannels2250(uint8_t usedChannels) : TransferBuffer(4) {
        this->init();
    ...
    /// \brief Sets the data array to needed values.
    BulkSetTrigger2250::BulkSetTrigger2250() : TransferBuffer(8) {
        this->init();
    }
    ...
    BulkSetTrigger2250::BulkSetTrigger2250(uint8_t triggerSource, uint8_t triggerSlope) : TransferBuffer(8) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetSamplerate5200::BulkSetSamplerate5200() : TransferBuffer(6) {
        this->init();
    }
    ...
    BulkSetSamplerate5200::BulkSetSamplerate5200(uint16_t samplerateSlow, uint8_t samplerateFast) : TransferBuffer(6) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetRecordLength2250::BulkSetRecordLength2250() : TransferBuffer(4) {
        this->init();
    }

    /// \brief Sets the data bytes to the specified values.
    /// \param recordLength The ::RecordLengthId value.
    BulkSetRecordLength2250::BulkSetRecordLength2250(uint8_t recordLength) : TransferBuffer(4) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetBuffer5200::BulkSetBuffer5200() : TransferBuffer(10) {
        this->init();
    }
    ...
    /// \param recordLength The ::RecordLengthId value.
    BulkSetBuffer5200::BulkSetBuffer5200(uint16_t triggerPositionPre, uint16_t triggerPositionPost, uint8_t usedPre, uint8_t usedPost, uint8_t recordLength) : TransferBuffer(10) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetSamplerate2250::BulkSetSamplerate2250() : TransferBuffer(8) {
        this->init();
    }
    ...
    BulkSetSamplerate2250::BulkSetSamplerate2250(bool fastRate, bool downsampling, uint16_t samplerate) : TransferBuffer(8) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetTrigger5200::BulkSetTrigger5200() : TransferBuffer(8) {
        this->init();
    }
    ...
    BulkSetTrigger5200::BulkSetTrigger5200(uint8_t triggerSource, uint8_t usedChannels, bool fastRate, uint8_t triggerSlope, uint8_t triggerPulse) : TransferBuffer(8) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    BulkSetBuffer2250::BulkSetBuffer2250() : TransferBuffer(10) {
        this->init();
    }
    ...
    /// \param triggerPositionPre The TriggerPositionPre value.
    /// \param triggerPositionPost The TriggerPositionPost value.
    BulkSetBuffer2250::BulkSetBuffer2250(uint32_t triggerPositionPre, uint32_t triggerPositionPost) : TransferBuffer(12) {
        this->init();
    ...
    /// \brief Sets the data array to the default values.
    ControlSetOffset::ControlSetOffset() : TransferBuffer(17) {
    }
    ...
    ControlSetOffset::ControlSetOffset(uint16_t channel1, uint16_t channel2, uint16_t trigger) : TransferBuffer(17) {
        this->setChannel(0, channel1);
        this->setChannel(1, channel2);
        this->setTrigger(trigger);
    }
    ...
    ControlSetRelays::ControlSetRelays(bool ch1Below1V, bool ch1Below100mV, bool ch1CouplingDC, bool ch2Below1V, bool ch2Below100mV, bool ch2CouplingDC, bool triggerExt) : TransferBuffer(17) {
