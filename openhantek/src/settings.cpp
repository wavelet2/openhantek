...
OpenHantekSettings::OpenHantekSettings(QWidget *parent) : QObject(parent) {
    // Options
    ...
    QList<OpenHantekSettingsOptionsWindowPanel *> panels;
...
/// \brief Cleans up.
OpenHantekSettings::~OpenHantekSettings() {
}

/// \brief Set the number of channels.
/// \param channels The new channel count, that will be applied to lists.
void OpenHantekSettings::setChannelCount(unsigned int channels) {
...
int OpenHantekSettings::load(const QString &fileName) {
    ...
    QList<OpenHantekSettingsOptionsWindowPanel *> docks;
    ...
    QList<OpenHantekSettingsOptionsWindowPanel *> toolbars;
    ...
    OpenHantekSettingsColorValues *colors;
