...
DsoConfigAnalysisPage::DsoConfigAnalysisPage(OpenHantekSettings *settings, QWidget *parent) : QWidget(parent) {
...
void DsoConfigAnalysisPage::saveSettings() {
    this->settings->scope.spectrumWindow = (DSOAnalyser::WindowFunction) this->windowFunctionComboBox->currentIndex();
...
/// \param settings The target settings object.
/// \param parent The parent widget.
DsoConfigColorsPage::DsoConfigColorsPage(OpenHantekSettings *settings, QWidget *parent) : QWidget(parent) {
    this->settings = settings;
    ...
    for(unsigned channel = 0; channel < this->settings->scope.voltage.size(); ++channel) {
        this->colorLabel.append(new QLabel(QString::fromStdString(this->settings->scope.voltage[channel].name)));
...
/// \param settings The target settings object.
/// \param parent The parent widget.
DsoConfigFilesPage::DsoConfigFilesPage(OpenHantekSettings *settings, QWidget *parent) : QWidget(parent) {
    this->settings = settings;
...
/// \param settings The target settings object.
/// \param parent The parent widget.
DsoConfigScopePage::DsoConfigScopePage(OpenHantekSettings *settings, QWidget *parent) : QWidget(parent) {
    this->settings = settings;
...
void DsoConfigScopePage::saveSettings() {
    ...
    this->settings->view.interpolation = (InterpolationMode) this->interpolationComboBox->currentIndex();
